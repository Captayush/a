...
public function studentbookissuereport(){
      ...
      // echo "<pre>"; print_r($data['issued_books']); echo "<pre>";die;
        $this->load->view('layout/header', $data);
...
public function issueinventory(){
    ...
    public function fees(){
            ...
            $this->load->view('layout/header',$data);
            $this->load->view('reports/fees',$data);
            $this->load->view('layout/footer',$data); 
    }
    ...
    public function fees_collection(){
            ...
            $this->load->view('layout/header',$data);
            $this->load->view('reports/fees_collection',$data);
            $this->load->view('layout/footer',$data); 
    }

    public function fees_collection_by_reciept(){
        $this->session->set_userdata('top_menu', 'Reports');
        ...
        $this->load->view('layout/header',$data);
        $this->load->view('reports/fees_collection_by_reciept',$data);
        $this->load->view('layout/footer',$data); 
    }
    ...
    public function fees_discount(){
        ...
        $this->load->view('layout/header',$data);
        $this->load->view('reports/fees_discount',$data);
        $this->load->view('layout/footer',$data); 
    }
...
$data['subject_name'] =  $teachers_reportvalue['subject_name'];
	...
	public function alumnireport()
    {
        ...
        $data['title']           = 'Alumini Student For Passout Session';
        $data['adm_auto_insert'] = $this->sch_setting_detail->adm_auto_insert;
        $data['sch_setting']     = $this->sch_setting_detail;
