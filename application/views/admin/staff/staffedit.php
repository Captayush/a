                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="fund_type" id="fund_type" autocomplete="off" value="pf" <?php if(!empty($staff["pf"] || $staff["pf"]!=0 )){ echo "checked"; } ?>>PF
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="fund_type" id="fund_type" autocomplete="off"  value="sf" <?php if(!empty($staff["sf"] || $staff["sf"]!=0 )){ echo "checked"; } ?>>SF
                                        </label>
                                 ...
                                 <div class="row">
                                    <div class="col-md-3 desc" id="pf" style="<?php if(empty($staff["pf"])){ echo "display:none;"; } ?>">
                                        <div class="form-group">
                                            <label for="pf1" class="control-label">P.F. Per Day For Both Side</label><small class="req"> *</small>
                                            <input type="text" id="pf1" name="pf" class="form-control"value="<?php if(!empty($staff["pf"])){ echo set_value('pf',$staff["pf"]); }else{ echo "0";} ?>" autocomplete="off">
                                            <span class="text-danger"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 desc" id="sf" style="<?php if(empty($staff["sf"])){ echo "display:none;"; } ?>">
                                        <div class="form-group">
                                            <label for="sf1" class="control-label">Security Fund</label>
                                            <small class="req"> *</small>
                                            <input type="text" id="sf1" name="sf" class="form-control" value="<?php if(!empty($staff["sf"])){ echo set_value('sf',$staff["sf"]); }else{ echo "0";} ?>">
                                            <span class="text-danger"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <small class="req"> *</small>
                                            <input type="time" id="in_time" name="in_time" class="form-control time" value="<?php echo set_value('in_time',$staff["in_time"]); ?>">
                                            <span class="text-danger"></span>
                                        </div>
                                    </div>
                                     ...
                                     <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <small class="req"> *</small>
                                            <input type="time" id="out_time" name="out_time" class="form-control time" value="<?php echo set_value('out_time',$staff["out_time"]); ?>">
                                            <span class="text-danger"></span>
                                        </div>
                                    </div>
                                </div>
...
<?php } ?>     
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="shift" name="shift" placeholder="" readonly type="text" class="form-control"  value="<?php echo $staff["shift"] ?>" />
