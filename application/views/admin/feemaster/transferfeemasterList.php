                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo "Add Transport Fees Master" . " : " . $this->setting_model->getCurrentSessionName(); ?></h3>
                        </div><!-- /.box-header -->
                        <form id="form1" action="<?php echo base_url() ?>admin/transportfeemaster"  id="feemasterform" name="feemasterform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label for="fee_groups_id"><?php echo $this->lang->line('fees_group'); ?></label> <small class="req">*</small>
        ...
        ?>">
            ...
            <div class="box box-primary">
                <div class="box-header ptbnull">
                    <h3 class="box-title titlefix"><?php echo "Transport Fees Master List" . " : " . $this->setting_model->getCurrentSessionName(); ?></h3>
                                    ...
                                    <tr>
                                                ...
                                                foreach ($feegroup->feetypes as $feetype_key => $feetype_value) {
                                                    ...
                                                    <li> <i class="fa fa-money"></i>
                                                        ...
                                                        <?php if ($this->rbac->hasPrivilege('fees_master', 'can_edit')) { ?>
                                                            <!--<a href="<?php echo base_url(); ?>admin/transportfeemaster/edit/<?php echo $feetype_value->id ?>"   data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">-->
                                                        ...
                                                        if ($this->rbac->hasPrivilege('fees_master', 'can_delete')) {
                                                            ?>
                                                            <a href="<?php echo base_url(); ?>admin/transportfeemaster/delete/<?php echo $feetype_value->id ?>" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
                                        ...
                                        <td class="mailbox-date pull-right">
                                            <?php if ($this->rbac->hasPrivilege('fees_group_assign', 'can_view')) { ?>
                                                <a data-placement="left" href="<?php echo base_url(); ?>admin/transportfeemaster/assign/<?php echo $feegroup->id ?>"
                                            ...
                                            <?php if ($this->rbac->hasPrivilege('fees_master', 'can_delete')) { ?>
                                                <a data-placement="left" href="<?php echo base_url(); ?>admin/transportfeemaster/deletegrp/<?php echo $feegroup->id ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
                                                    <i class="fa fa-remove"></i>
                                                </a>
                                            <?php } ?>
