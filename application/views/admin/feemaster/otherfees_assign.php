        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form role="form" action="<?php echo site_url('admin/otherfeemaster/assign/' . $id) ?>" method="post" class="row">
                ...
                <form method="post" action="<?php echo site_url('studentfee/addotherfeegroup') ?>" id="assign_form">
                    <?php
                    if (isset($resultlist)) {
                        ?>
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                foreach ($feegroupList as $feegroup) {
                                                    ...
                                                    <h4>
                                                        ...
                                                        <a href="#" data-toggle="popover" class="detail_popover"><?php if($feegroup->f_type=='1'){ echo "Caution Fees"; }else{ echo "Miscellaneous Fees"; } ?></a>
                                                    </h4>
                                                    ...
                                                    <table class="table">
                                                        <tbody>
                                                            <tr class="mailbox-name">
                                                                <td>
                                                                    <?php echo $feegroup->note; ?>
                                                                </td>
                                                                <td>
                                                                    
                                                                    <?php echo $currency_symbol . $feegroup->amount; ?>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                        ...
                                                        if (empty($resultlist)) {
                                                            ...
                                                            foreach ($resultlist as $student) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td> 
                                                                        <?php
                                                                        if ($student['student_other_fees_master_id'] != 0) {
                                                                            $sel = "checked='checked'";
                                                                        } else {
                                                                            $sel = "";
                                                                        }
                                                                        ...
                                                                        <input type="hidden" name="student_other_fees_master_id_<?php echo $student['student_session_id']; ?>" value="<?php echo $student['student_other_fees_master_id']; ?>">
