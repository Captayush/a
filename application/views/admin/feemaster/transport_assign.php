        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form role="form" action="<?php echo site_url('admin/transportfeemaster/assign/' . $id) ?>" method="post" class="row">
                ...
                <form method="post" action="<?php echo site_url('studentfee/addtransportfeegroup') ?>" id="assign_form">
                                                        ...
                                                        if (empty($resultlist)) {
                                                            ...
                                                            foreach ($resultlist as $student) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td> 
                                                                        <?php
                                                                        if ($student['student_transport_fees_master_id'] != 0) {
                                                                            $sel = "checked='checked'";
                                                                        } else {
                                                                            $sel = "";
                                                                        }
                                                                        ...
                                                                        <input type="hidden" name="student_transport_fees_master_id_<?php echo $student['student_session_id']; ?>" value="<?php echo $student['student_transport_fees_master_id']; ?>">
