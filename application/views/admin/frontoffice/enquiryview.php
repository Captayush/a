                                    ...
                                    if (empty($enquiry_list)) {
                                        ...
                                        foreach ($enquiry_list as $key => $value) {
                                            ...
                                            ?></td>
                                                ...
                                                <td> <a  href="<?php echo base_url(); ?>studentformfee/addfee/<?php echo $value['id'] ?>/3" class="btn btn-info btn-xs" data-toggle="tooltip" title="" data-original-title="" style="background: <?php if($value['paid_status']=='paid'){ echo "green"; }else{ echo "red"; } ?>">
                                                     <?php echo $currency_symbol; ?> Collect Form Fees
                                                    </a>
                                                </td> 
