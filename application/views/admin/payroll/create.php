                        ...
                        <div class="box-header">
                            <div class="row display-flex">
                                        ...
                                        <div class="payrollbox feebox">
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label">
                                                    ...
                                                    <?php if($payrol["pf"]!='0'){ ?>Salary With PF<?php }else{ ?> Salary<?php } ?>
                                                </label>
                                                <div class="col-sm-8">
                                             ...
                                             <div class="form-group">
                                                <label class="col-sm-4 control-label"> <?php if($payrol["pf"]!='0'){ ?>Salary With PF Per Day<?php }else{ ?> Salary Per Day <?php } ?> </label>
                                                <div class="col-sm-8">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    ...
                                    <!--<button type="button" onclick="add_more_deduction()" class="plusign"><i class="fa fa-plus"></i></button>-->
                                    <div class="sameheight" style="height: 48%;padding: 5px;">
                                        <div class="feebox">
                                            <table class="table3" id="tableID2">
                                                <tr id="deduction_row0">
                                                    <td style="width:40%;">
...
<script type="text/javascript">
    ...
    function add_allowance() {
		...
		var per_day_salary_with_pf = $("#per_day_salary_with_pf").val();
	    var sf = $("#sf").val();
		...
		if(sf==0){
            ...
            var attendance_allowance1 = (gross_salary-basic_main-hra-city_allowance-conveyance_allowance);
    		...
    		var absent_rupee1 = absent_day*per_day_salary_with_pf;
    		var absent_rupee = Math.round(absent_rupee1);
    		$("#absent_rupee").val(absent_rupee);
    		
    		var absent_in_time1 = (per_day_salary_with_pf/total_time);
            var absent_in_time_rupee1 = absent_in_time1*late_time;
            var absent_in_time_rupee =Math.round(absent_in_time_rupee1);
            $("#absent_time_rupee").val(absent_in_time_rupee);
            ...
            var gross_salary1 = basic_pay-absent_rupee-absent_in_time_rupee+absent_in_time_overtime;
            var gross_salary = Math.round(gross_salary1, 2);
            ...
            var net_salary = parseInt(gross_salary) - parseInt(salary_esi) - parseInt(advance) - parseInt(sf) ;
            ...
            var basic_main1 = basic_pay*fif;
            var basic_main =  Math.round(basic_main1);
            $("#salary_main").val(basic_main);
           
            var hra1 = (basic_pay-basic_main)*fif-absent_rupee*fif-(absent_in_time_rupee-absent_in_time_overtime)*fif;
            var hra =   Math.round(hra1);
            $("#hra").val(hra);
            
            var city_allowance1 = (basic_pay-basic_main)*twt-absent_rupee*twt-(absent_in_time_rupee-absent_in_time_overtime)*twt;
            var city_allowance =   Math.round(city_allowance1);
            $("#city_allowance").val(city_allowance);
            
            var conveyance_allowance1 = (basic_pay-basic_main)*twt-absent_rupee*twt-(absent_in_time_rupee-absent_in_time_overtime)*twt;
            var conveyance_allowance =   Math.round(conveyance_allowance1);
            $("#conveyance_allowance").val(conveyance_allowance);
