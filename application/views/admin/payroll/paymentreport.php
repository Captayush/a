            ...
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <div class="box-body">
                                ...
                                <form role="form" action="<?php echo site_url('admin/payroll/paymentreport') ?>" method="post" class="">
                                    ...
                                    <div class="col-sm-12">
                                     <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                          <div class="form-group">  
                                            <label>Select Months (Multiple)</label>
                                            <select name="month[]" class="form-control" id="e1" multiple>
                                                <option value=""><?php
                                                    echo $this->lang->line(
                                                            'select')
?></option>
                                    ...
                                    <table class="table table-striped table-bordered table-hover example table-fixed-header">
                                        <thead class="header">
                                            <tr>
                                                ...
                                                <th class="text text-right"> Month<span></span></th>
                                                <th class="text text-right"> Net Salary<span> <?php echo "(" . $currency_symbol . ")"; ?></span></th>
                                                <th class="text text-right"> PF Both Side<span> <?php echo "(" . $currency_symbol . ")"; ?></span></th>
                                                <th class="text text-right"> PF One Side<span> <?php echo "(" . $currency_symbol . ")"; ?></span></th>
                                                <th class="text text-right"> SF <span><?php echo "(" . $currency_symbol . ")"; ?></span></th>
                                                <th class="text text-right"> ESI <span><?php echo "(" . $currency_symbol . ")"; ?></span></th>
                                                <th class="text text-right"> Total Deduction <span><?php echo "(" . $currency_symbol . ")"; ?></span></th>
                                                <th class="text text-right"> Extra Income <span><?php echo "(" . $currency_symbol . ")"; ?></span></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            ...
                                            foreach ($result as $key => $value) {
                                                ...
                                                $total_deduction = $value["absent_rupee"] + $value["absent_time_rupee"];
                                                $total_deduction1 += $total_deduction;
                                                
                                                $extra_income = $value["over_time_rupee"];
                                                $extra_income1 += $extra_income;
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text text-right">
                                                        <?php echo number_format($value['net_salary'], 2, '.', ''); ?>
                                                    </td>
                                                    ...
                                                    <td class="text text-right">
                                                        <?php echo number_format($value['esi'], 2, '.', ''); ?>
                                                    </td>
                                                    ...
                                                    <td class="text text-right">
                                                        <?php echo number_format($extra_income, 2, '.', ''); ?>
                                                    </td>
                                        ...
                                        ?>
                                            <tr class="box box-solid total-bg">
                                                ...
                                                <td class="text text-right"><?php echo ($currency_symbol . number_format($esi, 2, '.', '')); ?></td>
                                                <td class="text text-right"><?php echo ($currency_symbol . number_format($total_deduction1, 2, '.', '')); ?></td>
                                                <td class="text text-right"><?php echo ($currency_symbol . number_format($extra_income1, 2, '.', '')); ?></td>
