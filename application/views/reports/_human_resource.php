                ...
                <h3 class="box-title"><i class="fa fa-search"></i>  <?php echo $this->lang->line('human_resource')." ".$this->lang->line('report')?></h3>
                    ...
                    <div class="">
                     ...
                     <?php if($this->rbac->hasPrivilege('staff_report','can_view')){ ?>
                                <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/human_resource/staff_report'); ?>">
                                    <a href="<?php echo base_url(); ?>report/staff_report"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('staff')." ".$this->lang->line('report'); ?></a>
                                </li>
                                     <?php
                                     }
                                ...
                                <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/payment/payment_report'); ?>">
                                    <a href="<?php echo base_url(); ?>admin/payroll/paymentreport"><i class="fa fa-file-text-o"></i> Payment Report</a>
                                </li>
                        <?php } ?>
                                                  </ul>
                    </div>
