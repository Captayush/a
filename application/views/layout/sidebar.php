                    ...
                    <li class="treeview <?php echo set_Topmenu('Fees Collection'); ?>">
                        ...
                        <ul class="treeview-menu">
                            <?php if ($this->rbac->hasPrivilege('collect_fees', 'can_view')) { ?>
                                ...
                                <li class="<?php echo set_Submenu('studenttransportfee/index'); ?>"><a href="<?php echo base_url(); ?>studenttransportfee"><i class="fa fa-angle-double-right"></i> Collect Transport Fees</a></li>
                                <li class="<?php echo set_Submenu('studentotherfee/index'); ?>"><a href="<?php echo base_url(); ?>studentotherfee"><i class="fa fa-angle-double-right"></i> Collect Others Fees</a></li>
                                <?php
                            }
                            ...
                            if ($this->rbac->hasPrivilege('fees_master', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('admin/transportfeemaster'); ?>"><a href="<?php echo base_url(); ?>admin/transportfeemaster"><i class="fa fa-angle-double-right"></i>Transport Fees Master</a></li>
                                
                                 <li class="<?php echo set_Submenu('admin/otherfeemaster'); ?>"><a href="<?php echo base_url(); ?>admin/otherfeemaster"><i class="fa fa-angle-double-right"></i>Others Fees Master</a></li>
                                <?php
                            }
                    ...
                    <li class="treeview <?php echo set_Topmenu('Reports'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if (($this->rbac->hasPrivilege('fees_statement', 'can_view') ||
                                ...
                                <li class="<?php echo set_Submenu('Reports/fees'); ?>"><a href="<?php echo base_url(); ?>report/fees"><i class="fa fa-angle-double-right"></i> Fees Report</a></li>

                                <li class="<?php echo set_Submenu('Reports/fees_collection'); ?>"><a href="<?php echo base_url(); ?>report/fees_collection"><i class="fa fa-angle-double-right"></i> Fees Collection Report</a></li>

                                <li class="<?php echo set_Submenu('Reports/fees_collection_by_reciept'); ?>"><a href="<?php echo base_url(); ?>report/fees_collection_by_reciept"><i class="fa fa-angle-double-right"></i> Fees Coll. By Reciept</a></li>

                                <li class="<?php echo set_Submenu('Reports/fees_discount'); ?>"><a href="<?php echo base_url(); ?>report/fees_discount"><i class="fa fa-angle-double-right"></i> Fees Discount Report</a></li>
