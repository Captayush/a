                ...
                ?>>
                    <div class="box-body box-profile">
                        ...
                        <?php 
                            ...
                            <li class="list-group-item listnoback">
                                <b>Register Type</b> <a class="pull-right text-aqua"><?php echo strtolower($student['register']); ?></a>
                            </li>
                            
                             <li class="list-group-item listnoback">
                                <b>Transport Fess</b> <a class="pull-right text-aqua"><?php if(!empty($student_due_tranportfee)){ echo "yes"; }else{ echo "no"; } ?></a>
                            </li>
                            
                             <li class="list-group-item listnoback">
                                <b>Other Fees</b> <a class="pull-right text-aqua"><?php if(!empty($student_due_otherfee)){ echo "yes"; }else{ echo "no"; } ?></a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        if ($this->module_lib->hasActive('fees_collection')) {
                            if (($this->rbac->hasPrivilege('collect_fees', 'can_view') ||
                                ...
                                <li class=""><a href="#transportfee" data-toggle="tab" aria-expanded="true">Transport Fees</a></li>
                                <li class=""><a href="#otherfee" data-toggle="tab" aria-expanded="true">Other Fees</a></li>
                                <?php
                            }
                        }
...
//5235
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="transportfee">
                            <?php
                            if (empty($student_due_tranportfee)) {
                                ?>
                                <div class="alert alert-danger">
                                    <?php echo $this->lang->line('no_record_found'); ?>
                                </div>
                                ...
                                <div class="table-responsive">    
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($student_due_tranportfee as $key => $fee) {
                         ...
                         <div class="tab-pane" id="otherfee">
                            <?php
                            if (empty($student_due_otherfee)) {
                                ?>
                                <div class="alert alert-danger">
                                    <?php echo $this->lang->line('no_record_found'); ?>
                                </div>
                                ...
                                <div class="table-responsive">    
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($student_due_otherfee as $key => $fee) {
                                                ...
                                                foreach ($fee->fees as $fee_key => $fee_value) {
                                                    ...
                                                    if ($feetype_balance > 0 && strtotime($fee_value->due_date) < strtotime(date('Y-m-d'))) {
                                                        ...
                                                        <td><?php
                                                            //echo $fee_value->name;
                                                            if($fee_value->fee_session_group_id=='1'){
                                                             echo "Caution Fees";   
                                                            }else{
                                                                echo "Miscellaneous Fees"; 
                                                            }
                                                            ?></td>
                                                        <td><?php echo $fee_value->note; ?></td>
                                                        <td class="text text-left">
