 ...
 <input id="measure_date" name="measure_date" placeholder="" type="text" class="form-control date"  value="<?php echo set_value('measure_date', date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($student['measurement_date']))); ?>" readonly="readonly"/>
                                        ...
                                        <div class="row">
                                            ...
                                            ?>
                                                ...
                                                <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="fees_group" class="control-label"><?php echo $this->lang->line('fees_register'); ?></label>
                                                    ...
                                                    <select id="register" name="register" class="form-control" autocomplete="off">
                                                        ...
                                                        <option value="FEES YPS 1" <?php if ($student['register'] == 'FEES YPS 1') {echo "selected =selected";} ?>>FEES YPS 1</option>
                                                        <option value="FEES YPSSS 2" <?php if ($student['register'] == 'FEES YPSSS 2') {echo "selected =selected";} ?>>FEES YPSSS 2</option>
                                                    </select>
        ...
        ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="specific_colony" name="specific_colony" placeholder="" type="text" class="form-control" value="<?php echo set_value('specific_colony', $student['specific_colony']); ?>" autocomplete="off">
                            ...
                            <div class="tshadow mb25 bozero">
                                ...
                                <div class="around10">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input id="father_qualification" name="father_qualification" placeholder="" type="text" class="form-control"  value="<?php echo set_value('father_occupation', $student['father_qualification']); ?>" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Mother Qualification</label>
                                                <input id="mother_qualification" name="mother_qualification" placeholder="" type="text" class="form-control"  value="<?php echo set_value('mother_qualification', $student['mother_qualification']); ?>" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="fsssm_id" name="fsssm_id" placeholder="" type="text" class="form-control"  value="<?php echo set_value('fsssm_id', $student['fsssm_id']); ?>" />
