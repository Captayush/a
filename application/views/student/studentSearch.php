                                ...
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('student/search') ?>" method="post" class="">
                                        ...
                                        <!--<input type="text" name="search_text" class="form-control" value="<?php  echo set_value('search_text'); ?>"   placeholder="<?php echo $this->lang->line('search_by_student_name'); ?>">-->
                                         <input type="text" name="search_text" class="form-control" value="<?php  echo set_value('search_text'); ?>"   placeholder="Search By Student Name, Roll Number, Enroll Number, Register Type, National Id, Local Id Etc.">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div class="slide-content">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-6 col-md-6">
                                                            ...
                                                            <b>Register Type :&nbsp; </b><?php echo $student['register'] ?><br>
                                                            </address>
                                                        </div>
                                                        <div class="col-xs-6 col-md-6">
