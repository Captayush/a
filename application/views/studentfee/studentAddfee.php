                    ...
                    <div class="box-body" style="padding-top:0;">
                        ...
                        <div class="row no-print">
                            <div class="col-md-12 mDMb10">
                                ...
                                <!--<a href="<?php echo base_url(); ?>Studentfee/addTransportfee/<?php echo $student['student_session_id'] ?>" class="btn btn-sm btn-warning"><i class="fa fa-bus"></i> Transport Fees</a>-->
                            ...
                            <table class="table table-striped table-bordered table-hover example table-fixed-header">
                                <thead class="header">
                                    <tr>
                                        ...
                                        ?>
                                        <th style="width: 10px">
                                        <!-- <input type="checkbox" id="select_all" value="<?php echo $fee->fees[0]->reciept_no; ?>"/> -->
                                        </th>
                                        ...
                                        <!--<th class="text text-left"><?php echo $this->lang->line('payment_id'); ?></th>-->
                                         <th class="text text-left">Reciept No.</th>
                                        <th class="text text-left"><?php echo $this->lang->line('mode'); ?></th>
                                        <th  class="text text-left"><?php echo $this->lang->line('date'); ?></th>
                                        <th class="text text-right" ><?php echo $this->lang->line('discount'); ?> <span><?php echo "(" . $currency_symbol . ")"; ?></span></th>
                                        <th class="text text-right"><?php echo $this->lang->line('fine'); ?> <span><?php echo "(" . $currency_symbol . ")"; ?></span></th>
                                        <th class="text text-right"><?php echo $this->lang->line('paid'); ?> <span><?php echo "(" . $currency_symbol . ")"; ?></span></th>
                                        <th class="text text-right">Total Paid <span><?php echo "(" . $currency_symbol . ")"; ?></span></th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($student_due_fee as $key => $fee) {
                                        ...
                                        foreach ($fee->fees as $fee_key => $fee_value) {
                                            ...
                                            $total_deposite_amount_fine = $total_deposite_amount + $fee_paid +$total_fine_amount;
                                            ...
                                            if ($feetype_balance > 0 && strtotime($fee_value->due_date) < strtotime(date('Y-m-d'))) {
                                                ...
                                                ?>
                                                <td><input class="checkbox" type="checkbox" value="<?php echo $fee_value->reciept_no; ?>" name="fee_checkbox" data-fee_master_id="<?php echo $fee_value->id ?>" data-fee_session_group_id="<?php echo $fee_value->fee_session_group_id ?>" data-fee_groups_feetype_id="<?php echo $fee_value->fee_groups_feetype_id ?>"></td>
                                                <td align="left"><?php
                                                    echo $fee_value->name;
                                                    ?></td>
                                                ...
                                                <td class="text text-right"><?php
                                                    echo (number_format($fee_paid+$fee_fine, 2, '.', ''));
                                                    ?></td>
                                            ...
                                            if (!empty($fee_value->amount_detail)) {
                                                ...
                                                foreach ($fee_deposits as $fee_deposits_key => $fee_deposits_value) {
                                                    ...
                                                    <tr class="white-td">
                                                        ...
                                                        <td class="text text-right"><?php echo (number_format($fee_deposits_value->amount+$fee_deposits_value->amount_fine, 2, '.', '')); ?></td>
                                                        <td></td>
                                    ...
                                    <tr class="box box-solid total-bg">
                                        ...
                                        <td class="text text-left">
                                            <?php
                                                echo ($currency_symbol . number_format($total_deposite_amount_fine, 2, '.', ''));
                                            ?></td>
                                        <td class="text text-right"><?php
            ...
            <div class="modal-body pb0">
                <div class="form-horizontal balanceformpopup">
                    <div class="box-body">
                        ...
                        <input  type="hidden"  id="student_fees_register" name="student_fees_register"  value="<?php echo $student['register']; ?>">
...
<script type="text/javascript">
    $(document).on('click', '.save_button', function (e) {
        ...
        var student_fees_register = $('#student_fees_register').val();
        ...
        $.ajax({
            ...
            type: 'post',
            data: {date: date, type: feetype, amount: amount, amount_discount: amount_discount, amount_fine: amount_fine, description: description, student_fees_master_id: student_fees_master_id, fee_groups_feetype_id: fee_groups_feetype_id, payment_mode: payment_mode, guardian_phone: guardian_phone, student_fees_register:student_fees_register, guardian_email: guardian_email, student_fees_discount_id: student_fees_discount_id,parent_app_key:parent_app_key},
            dataType: 'json',
            success: function (response) {
...
<script type="text/javascript">
    ...
    function calculate_single_entry_sum(entry_number) {
        var amount = $("#amount_fine_" + entry_number).val();
        // alert(amount);
        calculate_grand_total_for_purchase();
    }
    
    function calculate_grand_total_for_purchase() {
        var total_number = $(".amount_fine").length;
        fine_total = 0;
        for (var i = 1; i <= total_number; i++) {
            fine_total += Number($("#amount_fine_"+i).val());

        }
       
        $("#tot_fine").html(Math.round(fine_total));
        
        var amount_tot = $("#amount_tot").val();
        var fine_total1 = parseInt(amount_tot)+parseInt(fine_total);
        $("#tot_show").text(fine_total1);
