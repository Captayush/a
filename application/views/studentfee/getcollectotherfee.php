    ...
    if ($amount_to_be_pay > 0) {
        ...
        <li class="item">
            ...
            <div class="product-info">
                <a href="#" class="product-title"><?php 
                // echo $fee_value->name;
                if($fee_value->fee_groups_feetype_id=='1'){
                 echo "Caution Fees";   
                }else{
...
<input id="fee_session_group_id" name="fee_session_group_id" placeholder="" type="hidden" class="form-control date" value="<?php echo $fee_value->fee_session_group_id; ?>" readonly="readonly" autocomplete="off">
</ul>
