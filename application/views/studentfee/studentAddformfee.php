                                            ...
                                            <table class="table table-striped mb0 font13">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="bozero"><?php echo $student['name']; ?></td>
                                                        
                                                        <th class="bozero"><?php echo $this->lang->line('mobile_no'); ?></th>
                                                        <td class="bozero"><?php echo $student['contact']; ?></td>
            
                                                    </tr>
                                                    
                                                    <tr>
                                                        <th class="bozero" ><?php echo $this->lang->line('email'); ?></th>
                                                        <td class="bozero"><?php echo $student['email']; ?></td>
                                                        
                                                        <th  class="bozero"><?php echo $this->lang->line('address'); ?></th>
                                                        <td  class="bozero"><?php echo $student['address']; ?></td>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <th class="bozero"><?php echo $this->lang->line('source'); ?></th>
                                                        <td class="bozero"><?php echo $student['source']; ?></td>
                                                        
                                                        <th  class="bozero"><?php echo $this->lang->line('assigned'); ?></th>
                                                        <td  class="bozero"><?php echo $student['assigned']; ?></td>
                                                    </tr>
                                                    
                                                    <tr>
                                                        <th class="bozero" ><?php echo $this->lang->line('date'); ?></th>
                                                        <td class="bozero"><?php echo $student['date']; ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        ...
                                        foreach ($fee->fees as $fee_key => $fee_value) {
                                            ...
                                            if ($feetype_balance > 0 && strtotime($fee_value->due_date) < strtotime(date('Y-m-d'))) {
                                                ...
                                                <td align="left"><?php
                                                    ...
                                                    if($fee_value->fee_session_group_id=='3'){
                                                     echo "Form Fees";   
                                                    }
                                                    ?></td>
                                                    
                                                <td align="left"><?php echo $fee_value->note; ?></td>
...
<div id="listCollectionModal" class="modal fade">
    <div class="modal-dialog">
        <form action="<?php echo site_url('studentfee/addformfeegrp'); ?>" method="POST" id="collect_fee_group">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<script type="text/javascript">
    ...
    $(".date_fee").datepicker({
        ...
        $(document).on('click', '.printDoc', function () {
            ...
            $.ajax({
                url: '<?php echo site_url("studentfee/printOtherFeesByName") ?>',
                type: 'post',
        ...
        $(document).on('click', '.printInv', function () {
            ...
            $.ajax({
                url: '<?php echo site_url("studentfee/printformFeesByGroup") ?>',
                type: 'post',
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#confirm-delete').on('click', '.btn-ok', function (e) {
            ...
            $.ajax({
                type: "post",
                url: '<?php echo site_url("studentfee/deleteformpaidFee") ?>',
                dataType: 'JSON',
        ...
        $(document).on('click', '.btn-ok', function (e) {
            ...
            $.ajax({
                type: "post",
                url: '<?php echo site_url("studentfee/deleteotherpaidFee") ?>',
                dataType: 'JSON',
                data: {'main_invoice': main_invoice, 'sub_invoice': sub_invoice},
                success: function (data) {
                    $modalDiv.modal('hide').removeClass('modalloading');
    ...
    $(document).ready(function () {
        $(document).on('click', '.printSelected', function () {
            ...
            if (array_to_print.length === 0) {
                ...
                $.ajax({
                    url: '<?php echo site_url("studentfee/printFormFeesByGroupArray") ?>',
                    type: 'post',
        ...
        $(document).on('click', '.collectSelected', function () {
            ...
            $.ajax({
                type: 'POST',
                url: base_url + "studentfee/getcollectformfee",
