...
<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content">
        <?php $this->load->view('reports/_fees_collection_by_reciept');?>
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form role="form" action="<?php echo site_url('studentfee/collection_transport_report_by_reciept') ?>" method="post" class="">
                                    ...
                                    foreach ($results as $key => $value) {
                                        ...
                                        foreach ($value as $collect) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text text-right" style="font-weight:bold" ><?php echo $collect['amount_fine']; ?></td>
                                                <td class="text text-right " style="font-weight:bold" ><?php echo $t; ?></td>                                                
                                            </tr>
                                        <?php   
