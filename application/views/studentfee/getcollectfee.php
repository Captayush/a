...
<div class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            ...
            <label class="radio-inline">
                <input type="radio" name="payment_mode_fee" value="manual">Manual
            </label>
            <label class="radio-inline">
...
foreach ($feearray as $fee_key => $fee_value) {
    $amount_prev_paid = 0;
    $fine_amount_total+= $fee_value->fine_amount;
    ...
    if ($amount_to_be_pay > 0) {
        ...
        <li class="item">
            ...
            <input name="student_fees_register_<?php echo $row_counter; ?>" type="hidden" value="<?php echo $fee_value->register; ?>">
            ...
            <div class="product-info">
                <a href="#" class="product-title"><?php echo $fee_value->name; ?>
                    <span class="pull-right"><?php echo $amount_to_be_pay; ?></span>
                </a>
                ...
                <div class="col-md-5 col-sm-5">
                    <div class="">
                        <input type="text" class="form-control amount_fine" name="amount_fine_<?php echo $row_counter; ?>" onkeyup="calculate_single_entry_sum(<?php echo $row_counter; ?>)" id="amount_fine_<?php echo $row_counter; ?>" value="<?php echo $fee_value->fine_amount; ?>">
...
<div class="row collect_grp_fees">
    ...
    <div class="col-md-4">
        <input type="hidden" class="form-control" name="amount_tot" id="amount_tot" value="<?php echo $total_amount; ?>">
        <span class="pull-right" id="tot_show">
                  <?php echo number_format((float) $total_amount+$fine_amount_total, 2, '.', ''); ?>
        </span>
