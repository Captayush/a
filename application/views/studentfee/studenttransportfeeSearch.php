                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('studenttransportfee/search') ?>" method="post" class="">
                                    ...
                                    foreach ($resultlist as $student) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="pull-right">
                                                    ...
                                                    <a  href="<?php echo base_url(); ?>studenttransportfee/addfee/<?php echo $student['student_session_id'] ?>" class="btn btn-info btn-xs" data-toggle="tooltip" title="" data-original-title="">
