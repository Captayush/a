...
<div id="listCollectionModal" class="modal fade">
    <div class="modal-dialog">
        <form action="<?php echo site_url('studentfee/addotherfeegrp'); ?>" method="POST" id="collect_fee_group">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<script type="text/javascript">
    ...
    $(".date_fee").datepicker({
        ...
        $(document).on('click', '.printInv', function () {
            ...
            $.ajax({
                url: '<?php echo site_url("studentfee/printotherFeesByGroup") ?>',
                type: 'post',
    ...
    $(document).ready(function () {
        $(document).on('click', '.printSelected', function () {
            ...
            if (array_to_print.length === 0) {
                ...
                $.ajax({
                    url: '<?php echo site_url("studentfee/printOtherFeesByGroupArray") ?>',
                    type: 'post',
        ...
        $(document).on('click', '.collectSelected', function () {
            ...
            $.ajax({
                type: 'POST',
                url: base_url + "studentfee/getcollectotherfee",
