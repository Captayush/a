...
<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content">
        <?php $this->load->view('reports/_fees_discount');?>
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form role="form" action="<?php echo site_url('studentfee/discount_report_by_register') ?>" method="post" class="">
            ...
            <div class="">
                ...
                <div class="box-header ptbnull">
                    <h3 class="box-title titlefix"><i class="fa fa-money"></i> <?php  ?> <?php echo $this->lang->line('fees')." ".$this->lang->line('dicount')." ".$this->lang->line('report'); ?></h3> 
                </div>
                    ...
                    <table class="table table-striped  table-hover " id="headerTable">
                                <thead class="header">
                                    <tr>
                                        ...
                                        <th class="text text-right">Recieved Fees <span><?php echo "(" . $currency_symbol . ")"; ?></span></th>
                                  ...
                                  <?php
                                    ...
                                    foreach ($results as $key => $value) {
                                        ...
                                        foreach ($value as $collect) {
                                            ...
                                            $t_recieved = $collect['amount']-$collect['amount_discount'];

                                            if($collect['amount_discount']!='0'){
                                            ?>

                                            <tr>
                                                <td><?php echo $collect['reciept_no'];?></td>
                                                ...
                                                <td><?php echo $collect['firstname'] . " " . $collect['lastname'];?></td>
                                                <td><?php echo $collect['father_name'];?></td>
                                                <td><?php echo $collect['class'] . " (" . $collect['section'] . ")";?></td>
                                                <td><?php echo $collect['received_byname']['name']." (".$collect['received_byname']['employee_id'].")";?></td>
                                                <td style="font-weight:bold"><?php echo $collect['payment_mode'];?></td>
                                                <td><?php echo $collect['description'];?></td>
                                                <td class="text text-right" style="font-weight:bold"><?php echo $t_recieved; ?></td>
                                                <td class="text text-right" style="font-weight:bold" ><?php echo $collect['amount_discount'];?></td>
                                                <td class="text text-right " style="font-weight:bold" ><?php echo $collect['amount']; ?></td>                                                
                                            </tr>
                                        <?php   
                                          
                                         
                                            $fees_type[]=$collect['type'];
                                            $amountLabel[]=number_format($t_recieved, 2, '.', '');
