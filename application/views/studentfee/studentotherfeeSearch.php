                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('studentotherfee/search') ?>" method="post" class="">
                                    ...
                                    foreach ($resultlist as $student) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="pull-right">
                                                    ...
                                                    <a  href="<?php echo base_url(); ?>studentotherfee/addfee/<?php echo $student['student_session_id'] ?>/1" class="btn btn-info btn-xs" data-toggle="tooltip" title="" data-original-title="">
                                                    <?php //echo $currency_symbol; ?> <?php //echo $this->lang->line('collect_fees'); ?>
                                                     <?php echo $currency_symbol; ?> Collect Caution Fees
                                                    </a>
                                                    
                                                    <a  href="<?php echo base_url(); ?>studentotherfee/addfee/<?php echo $student['student_session_id'] ?>/2" class="btn btn-info btn-xs" data-toggle="tooltip" title="" data-original-title="">
                                                    <?php echo $currency_symbol; ?> Miscellaneous Fees
                                                    </a>
        <?php } ?>
                                            </td>
