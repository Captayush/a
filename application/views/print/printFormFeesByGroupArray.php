            						...
            						<thead>
                                        ...
                                        <tr>
                						    <td colspan="3">
                							    ...
                							    <div style="padding: 0px 5px 0 5px;font-size: 11px;"> Name : <b><?php echo $feearray[0]->name; ?></b></div>
                                        ...
                                        foreach ($feearray as $fee_key => $feeList) {
                                            ...
                                            <tr  class="dark-gray" style="">
                                                ...
                                                <td>
                                                    ...
                                                    <?php 
                                                    //echo $feeList->name; 
                                                    if($feeList->fee_session_group_id=='3'){ echo "Form Fees"; }else{ echo "Miscellaneous Fees"; }
                                                    ?> 
                                                        (<?php
